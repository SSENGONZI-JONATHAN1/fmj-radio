...
class NowPlayingInfo extends Equatable {
  ...
  /// NowPlayingInfo from AzuraCast API JSON
  factory NowPlayingInfo.fromAzuraCast(Map<String, dynamic> json) {
    try {
      final station = json['station'] as Map<String, dynamic>? ?? {};
      final nowPlaying = station['now_playing'] as Map<String, dynamic>? ?? {};
